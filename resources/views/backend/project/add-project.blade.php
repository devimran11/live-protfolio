                    ...
                    <section class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                    <h3>Add Project
                                        <a href="{{route('project.index')}}" class="btn btn-info btn-sm float-right"><i class="fa fa-list"></i>List Project</a>
                                    </h3>
                            </div>
                            <div class="card-body">
                                <form method="POST" action="{{route('project.store')}}" enctype="multipart/form-data">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" name="number_of_work" id="number_of_work" class="form-control">
